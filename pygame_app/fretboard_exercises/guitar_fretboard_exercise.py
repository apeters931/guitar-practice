...
def random_key():
    music_df = pd.read_csv(r'data\scales.csv')
    index_list = []
    for i in range(24):
        index_list.append(i)
...
def random_note(
    ...
    df = pd.read_csv(r'data\guitar_neck.csv')
...
def main():
    ...
    # set images
    vertical_button_unclicked_img = pygame.image.load(r'images\vertical_button_unclicked.png').convert_alpha()
    vertical_button_clicked_img = pygame.image.load(r'images\vertical_button_clicked.png').convert_alpha()
    horizontal_button_unclicked_img = pygame.image.load(r'images\horizontal_button_unclicked.png').convert_alpha()
    horizontal_button_clicked_img = pygame.image.load(r'images\horizontal_button_clicked.png').convert_alpha()
    zero_button_unclicked_img = pygame.image.load(r'images\zero_button_unclicked.png').convert_alpha()
    zero_button_clicked_img = pygame.image.load(r'images\zero_button_clicked.png').convert_alpha()
    one_button_unclicked_img = pygame.image.load(r'images\one_button_unclicked.png').convert_alpha()
    one_button_clicked_img = pygame.image.load(r'images\one_button_clicked.png').convert_alpha()
    two_button_unclicked_img = pygame.image.load(r'images\two_button_unclicked.png').convert_alpha()
    two_button_clicked_img = pygame.image.load(r'images\two_button_clicked.png').convert_alpha()
    three_button_unclicked_img = pygame.image.load(r'images\three_button_unclicked.png').convert_alpha()
    three_button_clicked_img = pygame.image.load(r'images\three_button_clicked.png').convert_alpha()
    four_button_unclicked_img = pygame.image.load(r'images\four_button_unclicked.png').convert_alpha()
    four_button_clicked_img = pygame.image.load(r'images\four_button_clicked.png').convert_alpha()
    five_button_unclicked_img = pygame.image.load(r'images\five_button_unclicked.png').convert_alpha()
    five_button_clicked_img = pygame.image.load(r'images\five_button_clicked.png').convert_alpha()
    six_button_unclicked_img = pygame.image.load(r'images\six_button_unclicked.png').convert_alpha()
    six_button_clicked_img = pygame.image.load(r'images\six_button_clicked.png').convert_alpha()
    seven_button_unclicked_img = pygame.image.load(r'images\seven_button_unclicked.png').convert_alpha()
    seven_button_clicked_img = pygame.image.load(r'images\seven_button_clicked.png').convert_alpha()
    eight_button_unclicked_img = pygame.image.load(r'images\eight_button_unclicked.png').convert_alpha()
    eight_button_clicked_img = pygame.image.load(r'images\eight_button_clicked.png').convert_alpha()
    nine_button_unclicked_img = pygame.image.load(r'images\nine_button_unclicked.png').convert_alpha()
    nine_button_clicked_img = pygame.image.load(r'images\nine_button_clicked.png').convert_alpha()
    ten_button_unclicked_img = pygame.image.load(r'images\ten_button_unclicked.png').convert_alpha()
    ten_button_clicked_img = pygame.image.load(r'images\ten_button_clicked.png').convert_alpha()
    eleven_button_unclicked_img = pygame.image.load(r'images\eleven_button_unclicked.png').convert_alpha()
    eleven_button_clicked_img = pygame.image.load(r'images\eleven_button_clicked.png').convert_alpha()
    twelve_button_unclicked_img = pygame.image.load(r'images\twelve_button_unclicked.png').convert_alpha()
    twelve_button_clicked_img = pygame.image.load(r'images\twelve_button_clicked.png').convert_alpha()
    ...
    am_key_button_unclicked_img = pygame.image.load(r'images\am_key_button_unclicked.png').convert_alpha()
    am_key_button_clicked_img = pygame.image.load(r'images\am_key_button_clicked.png').convert_alpha()
    bbm_key_button_unclicked_img = pygame.image.load(r'images\bbm_key_button_unclicked.png').convert_alpha()
    bbm_key_button_clicked_img = pygame.image.load(r'images\bbm_key_button_clicked.png').convert_alpha()
    bm_key_button_unclicked_img = pygame.image.load(r'images\bm_key_button_unclicked.png').convert_alpha()
    bm_key_button_clicked_img = pygame.image.load(r'images\bm_key_button_clicked.png').convert_alpha()
    cm_key_button_unclicked_img = pygame.image.load(r'images\cm_key_button_unclicked.png').convert_alpha()
    cm_key_button_clicked_img = pygame.image.load(r'images\cm_key_button_clicked.png').convert_alpha()
    csharpm_key_button_unclicked_img = pygame.image.load(r'images\csharpm_key_button_unclicked.png').convert_alpha()
    csharpm_key_button_clicked_img = pygame.image.load(r'images\csharpm_key_button_clicked.png').convert_alpha()
    dm_key_button_unclicked_img = pygame.image.load(r'images\dm_key_button_unclicked.png').convert_alpha()
    dm_key_button_clicked_img = pygame.image.load(r'images\dm_key_button_clicked.png').convert_alpha()
    dsharpm_key_button_unclicked_img = pygame.image.load(r'images\dsharpm_key_button_unclicked.png').convert_alpha()
    dsharpm_key_button_clicked_img = pygame.image.load(r'images\dsharpm_key_button_clicked.png').convert_alpha()
    em_key_button_unclicked_img = pygame.image.load(r'images\em_key_button_unclicked.png').convert_alpha()
    em_key_button_clicked_img = pygame.image.load(r'images\em_key_button_clicked.png').convert_alpha()
    fm_key_button_unclicked_img = pygame.image.load(r'images\fm_key_button_unclicked.png').convert_alpha()
    fm_key_button_clicked_img = pygame.image.load(r'images\fm_key_button_clicked.png').convert_alpha()
    fsharpm_key_button_unclicked_img = pygame.image.load(r'images\fsharpm_key_button_unclicked.png').convert_alpha()
    fsharpm_key_button_clicked_img = pygame.image.load(r'images\fsharpm_key_button_clicked.png').convert_alpha()
    gm_key_button_unclicked_img = pygame.image.load(r'images\gm_key_button_unclicked.png').convert_alpha()
    gm_key_button_clicked_img = pygame.image.load(r'images\gm_key_button_clicked.png').convert_alpha()
    gsharpm_key_button_unclicked_img = pygame.image.load(r'images\gsharpm_key_button_unclicked.png').convert_alpha()
    gsharpm_key_button_clicked_img = pygame.image.load(r'images\gsharpm_key_button_clicked.png').convert_alpha()
    e_button_unclicked_img = pygame.image.load(r'images\e_button_unclicked.png').convert_alpha()
    e_button_clicked_img = pygame.image.load(r'images\e_button_clicked.png').convert_alpha()
    a_button_unclicked_img = pygame.image.load(r'images\a_button_unclicked.png').convert_alpha()
    a_button_clicked_img = pygame.image.load(r'images\a_button_clicked.png').convert_alpha()
    d_button_unclicked_img = pygame.image.load(r'images\d_button_unclicked.png').convert_alpha()
    d_button_clicked_img = pygame.image.load(r'images\d_button_clicked.png').convert_alpha()
    g_button_unclicked_img = pygame.image.load(r'images\g_button_unclicked.png').convert_alpha()
    g_button_clicked_img = pygame.image.load(r'images\g_button_clicked.png').convert_alpha()
    b_button_unclicked_img = pygame.image.load(r'images\b_button_unclicked.png').convert_alpha()
    b_button_clicked_img = pygame.image.load(r'images\b_button_clicked.png').convert_alpha()
    ...
    def recurring(user_input, count=None, right=None):
        ...
        if neck_choice == 'horizontal':
            guitar_neck_image = pygame.image.load(r'images\horizontal_guitar_neck_nb.png')
